...
\quad + SFT (rank 64, 8 ep.) & 23.0 & 53.8 & 17.5 \\
\bottomrule
\end{tabular}
\caption{Best supervised configuration on the full DocVQA-2026 validation set (80Q), at matched $n{=}8$. The $+0.7$-point ANLS difference is within the base's $\pm 3.4$ sampling spread (a tie); pass@8 is tied and self-consistency (SC@8) is lower. Supervised fine-tuning does not beat the untrained base at matched power.}
\label{tab:sft}
\end{table}
